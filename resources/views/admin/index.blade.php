                                                    ...
                                                    <ul class="conversation-list">
                                                        <li class="clearfix">
                                                            <div class="chat-avatar">
                                                                <img src="admin/images/users/avatar-5.jpg" alt="male">
                                                                <i>10:00</i>
                                                            </div>
                                                        ...
                                                        <li class="clearfix odd">
                                                            <div class="chat-avatar">
                                                                <img src="{{asset('admin/images/users/avatar-1.')}}jpg" alt="Female">
                                                                <i>10:01</i>
                                                            </div>
                                                            <div class="conversation-text">
                                                                <div class="ctext-wrap">
                                                        ...
                                                        <li class="clearfix odd">
                                                            <div class="chat-avatar">
                                                                <img src="{{asset('admin/images/users/avatar-1.jpg')}}" alt="male">
                                                                <i>10:02</i>
                                                            </div>
                                                            <div class="conversation-text">
                                                                <div class="ctext-wrap">
