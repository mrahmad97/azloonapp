            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body mt-3">
                        ...
                        <form class="row g-3" action="{{ URL::to('update-category' . '/' . $editCategory->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-6">
                                <label for="category_name" class="form-label">Category Name</label>
                                <input type="text" placeholder="Category Name" class="form-control" name="category_name"
                                    id="category_name" value="{{ $editCategory->name }}" required>
                                @error('category_name')
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="file" class="form-control" name="image" id="image"
                                    value="{{ $editCategory->image }}" required>
                            </div>
                            <div class="col-md-6">
