                ...
                <div class="card">
                    <div class="card-header card_header p-0">
                        <h5 class="card-title" style="margin-left:10px; margin-right:10px; padding: 15px 0px 15px 0px;">All
                            Categories
                            <a href="{{ url('create-category') }}" class="btn btn-primary" style="float: right">Create
                                Category</a>
                        </h5>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                @if (!empty($categories))
                                    @foreach ($categories as $key => $category)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td><img src="{{ Storage::url($category->imageURL) }}" alt="no Image" width="35"
                                                    height="35"></td>
                                            <td>{{ $category->name }}</td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ url('destroy-category/' . $category->id) }}"
