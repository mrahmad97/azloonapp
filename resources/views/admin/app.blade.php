                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="notify-icon">
                                                        <img src="{{asset('admin/images/users/avatar-1.jpg')}}" class="img-fluid rounded-circle"
                                                            alt="" />
                                                    </div>
                                                </div>
                                    ...
                                    <a href="javascript:void(0);"
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="notify-icon">
                                                        <img src="{{asset('admin/images/users/avatar-2.jpg')}}" class="img-fluid rounded-circle"
                                                            alt="" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
                                    ...
                                    <a href="javascript:void(0);"
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="notify-icon">
                                                        <img src="{{asset('admin/images/users/avatar-3.jpg')}}" class="img-fluid rounded-circle"
                                                            alt="" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
                                    ...
                                    <a href="javascript:void(0);"
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="notify-icon">
                                                        <img src="{{asset('admin/images/users/avatar-4.jpg')}}" class="img-fluid rounded-circle"
                                                            alt="" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
                                    ...
                                    <a href="javascript:void(0);"
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="notify-icon">
                                                        <img src="{{asset('admin/images/users/avatar-5.jpg')}}" class="img-fluid rounded-circle"
                                                            alt="" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a href="{{url('/manager')}}" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarPages">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="{{url('create-category')}}">Create Ctegory</a>
                                    </li>
                                    <li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarLayouts">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="{{url('create-sub-category')}}">Create Sub Ctegory</a>
                                    </li>
                                    <li>
                                        <a href="{{url('sub-categories')}}">All Sub Categories</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarPages">
                                <ul class="side-nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{url('brands')}}">All Brands</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarLayouts">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="{{url('create-banner')}}">Create Banner</a>
                                    </li>
                                    <li>
                                        <a href="{{url('banners')}}">All Banners</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarLayouts">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="{{url('create-flash-deal')}}">Create Flash deal</a>
                                    </li>
                                    <li>
                                        <a href="{{url('flash-deals')}}">All Flashdeals</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
